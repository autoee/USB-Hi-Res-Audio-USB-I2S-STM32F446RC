...
{
  CONFIG_1_GPIO->PUPDR |= 1 << (2 * CONFIG_1_PIN);
  CONFIG_2_GPIO->PUPDR |= (1 << (2 * CONFIG_2_PIN)) | (1 << (2 * CONFIG_3_PIN));
  while(((CONFIG_1_GPIO->PUPDR & (1 << (2 * CONFIG_1_PIN))) != (1 << (2 * CONFIG_1_PIN)))
     || ((CONFIG_2_GPIO->PUPDR & ((1 << (2 * CONFIG_2_PIN)) | (1 << (2 * CONFIG_3_PIN))))
         != ((1 << (2 * CONFIG_2_PIN)) | (1 << (2 * CONFIG_3_PIN)))));
  
  OUT_CLK_CONFIG_1_GPIO->PUPDR |= (1 << (2 * OUT_CLK_CONFIG_1_PIN)) | (1 << (2 * OUT_CLK_CONFIG_3_PIN)) | \
                                  (1 << (2 * CONFIG_DELAY_PIN));
  while((OUT_CLK_CONFIG_1_GPIO->PUPDR & ((1 << (2 * OUT_CLK_CONFIG_1_PIN)) | (1 << (2 * OUT_CLK_CONFIG_3_PIN)) | (1 << (2 * CONFIG_DELAY_PIN))))
                                     != ((1 << (2 * OUT_CLK_CONFIG_1_PIN)) | (1 << (2 * OUT_CLK_CONFIG_3_PIN)) | (1 << (2 * CONFIG_DELAY_PIN))));
  
  OUT_CLK_CONFIG_2_GPIO->MODER &= ~(3 << (2 * OUT_CLK_CONFIG_2_PIN));
  OUT_CLK_CONFIG_2_GPIO->MODER |= 1 << (2 * OUT_CLK_CONFIG_2_PIN);
  while((OUT_CLK_CONFIG_2_GPIO->MODER & (1 << (2 * OUT_CLK_CONFIG_2_PIN))) != (1 << (2 * OUT_CLK_CONFIG_2_PIN)));
